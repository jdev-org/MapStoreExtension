...
export default function Tabou2AddPanel({feature, featureId, layer, ...props}) {
    ...
    return (
        <Grid className={"col-xs-12"}>
            ...
            {
                type === "layerPA" ? <Tabou2AddOaPaForm layer={type} feature={selectedFeature} {...props} childs={ADD_PA_FORM} pluginCfg={props.pluginCfg} /> : null
            }
            {
                type === "layerOA" ? <Tabou2AddOaPaForm layer={type} feature={selectedFeature} {...props} childs={ADD_OA_FORM} pluginCfg={props.pluginCfg} /> : null
            }
                        {
                type === "layerSA" ? <Tabou2AddOaPaForm layer={type} feature={selectedFeature} {...props} childs={ADD_OA_FORM} pluginCfg={props.pluginCfg} /> : null
            }
        </Grid >
    );
}
